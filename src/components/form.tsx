...
export default function Form() {
  ...
  return (
    <div className="gap-4 sm:gap-8 flex flex-col w-full">
      ...
      <select
        className="bg-transparent outline-none border-0 appearance-none text-white/40 py-2.5 px-2.5 ring-1 ring-white/20 focus-within:ring-[#D16014]/50 focus-within:ring-2 rounded-md"
        name="region"
        value={region}
